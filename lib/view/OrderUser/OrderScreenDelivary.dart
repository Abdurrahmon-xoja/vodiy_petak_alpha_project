...
class OrderScreenDelivary extends StatefulWidget {
  const OrderScreenDelivary({super.key});

  @override
  State<OrderScreenDelivary> createState() => _OrderScreenDelivaryState();
}
...
class _OrderScreenDelivaryState extends State<OrderScreenDelivary>
  ...
  void initRideInfo() async {
    isUsersOrderInProggres =
        await Api.isUsersDelivaryInProgress({'id': renderingData['id']});
    setState(() {
      isUsersOrderInProggres;
    });
  }
  ...
  void initState() {
    ...
    renderingData =
        jsonDecode(LocalMemory.getValue("useOrderInsideInfoDelivary"));
    initRideInfo();
  }
